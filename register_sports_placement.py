...
# Returns who won or tied as an int
...
# Total goals scored and total goals conceded for both teams
...
# Calls all functions and returns final standings for the match
def add_standings(standings, l_team, r_team, l_score, r_score):
    ...
    # Adds the given goals scored for both teams 
